...
DEFAULT_PACKAGES_LINUX  := hypr waybar kitty ghostty nvim zsh git scripts wofi dunst zed ohmyposh herdr codex gemini
DEFAULT_PACKAGES_DARWIN := kitty ghostty nvim zsh git scripts zed ohmyposh herdr codex gemini
DEFAULT_PACKAGES_OTHER  := kitty ghostty nvim zsh git scripts zed ohmyposh herdr codex gemini
